...
using CloudMqttClientOne.MqttLib.Core;
using CloudMqttClientOne.MqttLib.Core.Messages;
using CloudMqttClientOne.MqttLib.Logger;
using CloudMqttClientOne.MqttLib.MatchTree;
    ...
    internal class Mqtt : IMqtt, IMqttShared
    {
        ...
        protected void OnPublishArrived(MqttPublishMessage m)
        {
            ...
            if (PublishArrived != null)
            {
                ...
                {
                    global::CloudMqttClientOne.MqttLib.Logger.Log.Write(LogLevel.ERROR, "MqttLib: Uncaught exception from user delegate: " + ex.ToString());
                }
            }
